...
declare namespace pc {
    ...
    * {number} view: Type of view. Can be pc.VIEW_CENTER, pc.VIEW_LEFT or pc.VIEW_RIGHT. Left and right are only used in stereo rendering.
    ...
    class RigidBodyComponent extends pc.Component {
         ...
         * if the ray hits an entity with a collision component, it returns a pc.RaycastResult, 
         * otherwise returns null.
         */
        raycastAll(start: pc.Vec3, end: pc.Vec3): pc.RaycastResult;
        /**
         * Raycast the world and return all entities the ray hits. It returns an array of pc.RaycastResult, 
         * one for each hit. If no hits are detected, the returned array will be of length 0.
         */
